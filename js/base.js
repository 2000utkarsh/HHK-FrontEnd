Vue.component('vue_carousel-dot', {
  ...
  Vue.component('vue_carousel-dots', {
    props: ['numDots'],
    template: '<div class="dots"><vue_carousel-dot v-for="i in numDots"></vue_carousel-dot></div>' });
  
  
  // Items displayed in the vue_carousel
  Vue.component('vue_carousel-item', {
    template: '<div class="vue_carousel-item" v-bind:style="style" v-on:click="centerSelf"><slot></slot></div>',
    data: () => ({
      zIndex: 0,
      xtrans: 0,
      ytrans: 0,
  ...
  // vue_carousel component
  Vue.component('vue_carousel', {
    // Render function wraps all children in vue_carousel-item components
    render(createElement) {
      ...
      this.$slots.default.map(el => createElement('vue_carousel-item', [el])));
  
    },
  
    data: () => ({}),
  
    // Begin by centering the first element in the vue_carousel
